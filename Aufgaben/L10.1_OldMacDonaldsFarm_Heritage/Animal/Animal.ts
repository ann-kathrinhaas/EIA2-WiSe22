namespace L10_OldMacDonaldsFarm_Heritage {
    ...
    export class Animal {
        ...
        sing(): void {
            animalDiv.innerHTML += "Old MacDonald had a farm <br> and on his farm he had a " + this.specie + " named " + this.name + " that makes " + this.sound + " and eats " + this.amount + " kg of " + this.food.type + "<br>";
        }
