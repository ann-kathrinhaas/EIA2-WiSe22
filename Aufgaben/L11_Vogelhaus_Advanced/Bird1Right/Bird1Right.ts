namespace L11_Vogelhaus_Advanced {
    export class Bird1Right extends Moveable {
        ...
        private drawTail(_x1: number, _y1: number, _x2: number, _y2: number, _x3: number, _y3: number, _x4: number, _y4: number, _x5: number, _y5: number, _x6: number, _y6: number, _x7: number, _y7: number, _color: string): void {
            crc2.beginPath();
            crc2.moveTo(_x1, _y1);
            crc2.lineTo(_x2, _y2);
            crc2.lineTo(_x3, _y3);
