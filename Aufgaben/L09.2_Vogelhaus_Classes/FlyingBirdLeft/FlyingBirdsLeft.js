...
(function (L09_Vogelhaus_Classes) {
    class FlyingBirdLeft {
        ...
        colorBody;
        colorHead;
        randomVelocity = (Math.random() * 4) + 1.5;
        constructor() {
        ...
        move(_timeslice) {
            this.position.x -= this.randomVelocity;
            if (this.position.x < 0) // wenn Vogel nach links rausgeht
...
//# sourceMappingURL=FlyingBirdsLeft.js.map