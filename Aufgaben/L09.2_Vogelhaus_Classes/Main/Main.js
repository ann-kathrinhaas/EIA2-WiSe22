...
(function (L09_Vogelhaus) {
    ...
    function handleLoad(_event) {
        ...
        console.log("Canvas");
        let horizon = L09_Vogelhaus.crc2.canvas.height * golden;
    ...
    function drawCloud(_position, _size) {
        ...
        for (let drawn = 0; drawn < nParticles; drawn++) {
            ...
            L09_Vogelhaus.crc2.translate(x, y); // schiebt Koordinatensysten an richtige Posotion
            L09_Vogelhaus.crc2.fill(particle); // draw particle
            L09_Vogelhaus.crc2.restore(); // an Wolkenposition
        }
        L09_Vogelhaus.crc2.restore();
    }
    ...
    function drawArc(_x, _y, _radius, _startAngle, _endAngle, _color) {
        L09_Vogelhaus.crc2.beginPath();
        L09_Vogelhaus.crc2.arc(_x, _y, _radius, _startAngle, _endAngle * Math.PI);
        L09_Vogelhaus.crc2.fillStyle = _color;
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.closePath();
    }
    function drawRect(_x, _y, _w, _h, _color) {
        L09_Vogelhaus.crc2.beginPath();
        L09_Vogelhaus.crc2.rect(_x, _y, _w, _h);
        L09_Vogelhaus.crc2.fillStyle = _color;
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.closePath();
    }
    function drawEllipse(_x, _y, _radiusX, _radiusY, _rotation, _startAngle, _endAngle, _color) {
        L09_Vogelhaus.crc2.beginPath();
        L09_Vogelhaus.crc2.ellipse(_x, _y, _radiusX, _radiusY, _rotation, _startAngle, _endAngle * Math.PI);
        L09_Vogelhaus.crc2.fillStyle = _color;
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.closePath();
    }
    function drawLine(_x1, _y1, _x2, _y2, _color, _lineWidth, _lineCap) {
        L09_Vogelhaus.crc2.beginPath();
        L09_Vogelhaus.crc2.moveTo(_x1, _y1);
        L09_Vogelhaus.crc2.lineTo(_x2, _y2);
        L09_Vogelhaus.crc2.strokeStyle = _color;
        L09_Vogelhaus.crc2.lineWidth = _lineWidth;
        switch (_lineCap) {
            case 1:
                L09_Vogelhaus.crc2.lineCap = "butt";
                break;
            case 2:
                L09_Vogelhaus.crc2.lineCap = "round";
                break;
        }
    ...
    function drawPlane(_x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4, _color) {
        ...
        L09_Vogelhaus.crc2.moveTo(_x1, _y1);
        L09_Vogelhaus.crc2.lineTo(_x2, _y2);
        L09_Vogelhaus.crc2.lineTo(_x3, _y3);
        L09_Vogelhaus.crc2.lineTo(_x4, _y4);
        L09_Vogelhaus.crc2.fillStyle = _color;
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.closePath();
    }
    ...
    function drawChristmasTree(_position) {
        ...
        switch (color1) {
            case 0:
                L09_Vogelhaus.crc2.fillStyle = "red";
                break;
            case 1:
                L09_Vogelhaus.crc2.fillStyle = "blue";
                break;
            case 2:
                L09_Vogelhaus.crc2.fillStyle = "orange";
                break;
        }
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.beginPath();
        ...
        switch (color2) {
            case 0:
                L09_Vogelhaus.crc2.fillStyle = "yellow";
                break;
            case 1:
                L09_Vogelhaus.crc2.fillStyle = "green";
                break;
            case 2:
                L09_Vogelhaus.crc2.fillStyle = "violet";
                break;
        }
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.beginPath();
        ...
        switch (color3) {
            case 0:
                L09_Vogelhaus.crc2.fillStyle = "pink";
                break;
            case 1:
                L09_Vogelhaus.crc2.fillStyle = "purple";
                break;
            case 2:
                L09_Vogelhaus.crc2.fillStyle = "mediumseagreen";
                break;
        }
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.beginPath();
        ...
        switch (color4) {
            case 0:
                L09_Vogelhaus.crc2.fillStyle = "aqua";
                break;
            case 1:
                L09_Vogelhaus.crc2.fillStyle = "salmon";
                break;
            case 2:
                L09_Vogelhaus.crc2.fillStyle = "teal";
                break;
        }
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.beginPath();
        ...
        switch (color5) {
            case 0:
                L09_Vogelhaus.crc2.fillStyle = "bisque";
                break;
            case 1:
                L09_Vogelhaus.crc2.fillStyle = "chocolate";
                break;
            case 2:
                L09_Vogelhaus.crc2.fillStyle = "slateblue";
                break;
        }
        L09_Vogelhaus.crc2.fill();
        // Stern
    ...
    function drawTail(_x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4, _x5, _y5, _x6, _y6, _x7, _y7, _color) {
        ...
        L09_Vogelhaus.crc2.lineTo(_x3, _y3);
        L09_Vogelhaus.crc2.lineTo(_x4, _y4);
        L09_Vogelhaus.crc2.lineTo(_x5, _y5);
        L09_Vogelhaus.crc2.lineTo(_x6, _y6);
        L09_Vogelhaus.crc2.lineTo(_x7, _y7);
        L09_Vogelhaus.crc2.fillStyle = _color;
        L09_Vogelhaus.crc2.fill();
        L09_Vogelhaus.crc2.closePath();
    }
