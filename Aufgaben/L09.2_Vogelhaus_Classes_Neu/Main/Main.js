...
(function (L09_Vogelhaus_Classes) {
    ...
    function handleLoad(_event) {
        ...
        if (!canvas)
            return;
        L09_Vogelhaus_Classes.crc2 = canvas.getContext("2d");
        console.log("Canvas");
        let horizon = L09_Vogelhaus_Classes.crc2.canvas.height * golden;
        ...
        drawBirds();
        background = L09_Vogelhaus_Classes.crc2.getImageData(0, 0, canvas.width, canvas.height);
        drawBirdsAnimated();
        drawSnowflakes();
        window.setInterval(update, 20);
    }
    function update() {
        L09_Vogelhaus_Classes.crc2.putImageData(background, 0, 0);
    ...
    function drawSnowflakes() {
        ...
        for (let drawn = 0; drawn < nSnowflakes; drawn++) {
            snowflakes.push(new L09_Vogelhaus_Classes.Snowflake());
        }
    }
    ...
    function drawBackground() {
        ...
        let gradient = L09_Vogelhaus_Classes.crc2.createLinearGradient(0, 0, 0, L09_Vogelhaus_Classes.crc2.canvas.height);
        ...
        ;
        L09_Vogelhaus_Classes.crc2.fillStyle = gradient;
        L09_Vogelhaus_Classes.crc2.fillRect(0, 0, L09_Vogelhaus_Classes.crc2.canvas.width, L09_Vogelhaus_Classes.crc2.canvas.height);
    }
    function drawSun(_position) {
        console.log("Sun");
        let r1 = 30;
        let r2 = 100;
        let gradient = L09_Vogelhaus_Classes.crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
        gradient.addColorStop(0, "HSLA(60, 100%, 90%, 1)");
        gradient.addColorStop(1, "HSLA(60, 100%, 50%, 0)");
        L09_Vogelhaus_Classes.crc2.save();
        L09_Vogelhaus_Classes.crc2.translate(_position.x, _position.y);
        L09_Vogelhaus_Classes.crc2.fillStyle = gradient;
        L09_Vogelhaus_Classes.crc2.arc(0, 0, r2, 0, 2 * Math.PI);
    ...
    function drawCloud(_position, _size) {
        ...
        let gradient = L09_Vogelhaus_Classes.crc2.createRadialGradient(0, 0, 0, 0, 0, radiusParticle);
        ...
        for (let drawn = 0; drawn < nParticles; drawn++) {
            ...
            L09_Vogelhaus_Classes.crc2.translate(x, y); // schiebt Koordinatensysten an richtige Posotion
            L09_Vogelhaus_Classes.crc2.fill(particle); // draw particle
            L09_Vogelhaus_Classes.crc2.restore(); // an Wolkenposition
        }
        L09_Vogelhaus_Classes.crc2.restore();
    }
    function drawMountains(_position, _min, _max, _colorLow, _colorHigh) {
        ...
        L09_Vogelhaus_Classes.crc2.moveTo(0, 0);
        L09_Vogelhaus_Classes.crc2.lineTo(0, -_max);
        do {
            x += stepMin + Math.random() * (stepMax - stepMin);
            let y = -_min - Math.random() * (_max - _min);
            L09_Vogelhaus_Classes.crc2.lineTo(x, y);
        } while (x < L09_Vogelhaus_Classes.crc2.canvas.width);
        L09_Vogelhaus_Classes.crc2.lineTo(x, 0);
        L09_Vogelhaus_Classes.crc2.closePath();
        let gradient = L09_Vogelhaus_Classes.crc2.createLinearGradient(0, 0, 0, -_max);
    ...
    function drawRect(_x, _y, _w, _h, _color) {
        L09_Vogelhaus_Classes.crc2.beginPath();
        L09_Vogelhaus_Classes.crc2.rect(_x, _y, _w, _h);
        L09_Vogelhaus_Classes.crc2.fillStyle = _color;
        L09_Vogelhaus_Classes.crc2.fill();
        L09_Vogelhaus_Classes.crc2.closePath();
    }
    ...
    function drawTrees() {
        ...
        for (let drawn = 0; drawn <= nTrees; drawn++) {
            ...
            L09_Vogelhaus_Classes.crc2.translate(x, y);
            L09_Vogelhaus_Classes.crc2.restore();
        }
        // Baumreihe vorne
        for (let drawn = 0; drawn <= nTrees; drawn++) {
    ...
    function drawChristmasTree(_position) {
        ...
        switch (color1) {
            case 0:
                L09_Vogelhaus_Classes.crc2.fillStyle = "red";
                break;
            case 1:
                L09_Vogelhaus_Classes.crc2.fillStyle = "blue";
                break;
            case 2:
                L09_Vogelhaus_Classes.crc2.fillStyle = "orange";
                break;
        }
        L09_Vogelhaus_Classes.crc2.fill();
        L09_Vogelhaus_Classes.crc2.beginPath();
        ...
        switch (color2) {
            case 0:
                L09_Vogelhaus_Classes.crc2.fillStyle = "yellow";
                break;
            case 1:
                L09_Vogelhaus_Classes.crc2.fillStyle = "green";
                break;
            case 2:
                L09_Vogelhaus_Classes.crc2.fillStyle = "violet";
                break;
        }
        L09_Vogelhaus_Classes.crc2.fill();
        L09_Vogelhaus_Classes.crc2.beginPath();
        ...
        switch (color3) {
            case 0:
                L09_Vogelhaus_Classes.crc2.fillStyle = "pink";
                break;
            case 1:
                L09_Vogelhaus_Classes.crc2.fillStyle = "purple";
                break;
            case 2:
                L09_Vogelhaus_Classes.crc2.fillStyle = "mediumseagreen";
                break;
        }
        L09_Vogelhaus_Classes.crc2.fill();
        L09_Vogelhaus_Classes.crc2.beginPath();
        ...
        switch (color4) {
            case 0:
                L09_Vogelhaus_Classes.crc2.fillStyle = "aqua";
                break;
            case 1:
                L09_Vogelhaus_Classes.crc2.fillStyle = "salmon";
                break;
            case 2:
                L09_Vogelhaus_Classes.crc2.fillStyle = "teal";
                break;
        }
        L09_Vogelhaus_Classes.crc2.fill();
        L09_Vogelhaus_Classes.crc2.beginPath();
        ...
        switch (color5) {
            case 0:
                L09_Vogelhaus_Classes.crc2.fillStyle = "bisque";
                break;
            case 1:
                L09_Vogelhaus_Classes.crc2.fillStyle = "chocolate";
                break;
            case 2:
                L09_Vogelhaus_Classes.crc2.fillStyle = "slateblue";
                break;
        }
        L09_Vogelhaus_Classes.crc2.fill();
        // Stern
